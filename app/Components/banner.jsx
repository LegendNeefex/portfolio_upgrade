...
function Banner() {
  ...
  return (
        <div className="bg-linear-to-r from-secondary to-primary h-165 overflow-hidden" id='home'>
            <div className="flex justify-between items-center w-[95%] m-auto pt-22.5 relative mt-48" >
                ...
                <div className=''>
                    <div className='absolute right-30 -top-15 bg-accent opacity-50 w-120 h-120 rounded-full blur-xl '></div>
                    <Image
                        src="/Image/Pic.png"
                        width={700}
                        height={500}
                ...
                <div className='rounded-lg z-10 px-2 py-2 cursor-pointer bg-muted'>
