...
function ProjectPage() {
    ...
    const [selectedAsset, setSelectedAsset] = useState(null); // ← added
                    ...
                    >
                        ...
                        >
                            ...
                            <ul className='flex gap-4 items-center'>
                                <li>
                                    <ScrollLink onClick={() => handleSetActive("gallery")} className={`p-3 no-underline text-[#0F6A58] text-[16px] font-lato font-medium cursor-pointer border-2 border-[#0F6A58] rounded-xl ${activeSection === "gallery" ? "bg-[#0F6A58] text-neutral-white" : ""}`} to="gallery" smooth={true} duration={500} offset={-70}>
                                        Gallery
                                    </ScrollLink>
                                </li>
                                <li> 
                                    <ScrollLink onClick={() => handleSetActive("features")} className={`p-3 no-underline text-[#0F6A58] text-[16px] font-lato font-medium cursor-pointer border-2 border-[#0F6A58] rounded-xl ${activeSection === "features" ? "bg-[#0F6A58] text-neutral-white" : ""}`} to="features" smooth={true} duration={500} offset={-70}>
                                        Features
                                    </ScrollLink>
                                </li>
                                <li> 
